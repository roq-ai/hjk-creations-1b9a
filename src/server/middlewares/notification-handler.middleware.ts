...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order_created.create': { roles: ['owner', 'team-member'], key: 'order_id', tenantPath: [], userPath: [] },
  'payment_received.create': { roles: ['owner', 'team-member'], key: 'payment_id', tenantPath: [], userPath: [] },
  'ticket_created.create': { roles: ['owner', 'team-member'], key: 'ticket_id', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['owner'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['owner', 'team-member', 'end-customer'];
