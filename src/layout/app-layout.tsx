...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'team-member', 'end-customer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Clients', path: '/clients', entity: 'client', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Data', path: '/data', entity: 'data', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Reports', path: '/reports', entity: 'report', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Updates', path: '/updates', entity: 'update', service: AccessServiceEnum.PROJECT, icon: FiBox },
